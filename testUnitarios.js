...
describe('Test for Validation Module', function () {
    describe('Testing function ValidationEmail', function () {
        it('-Should get false, when try to pass in the arguments: \'?\'', function () {
        ...
        it('-Should get true, when pass as arguments: \'analefinir@gmail.com\'', function () {
            assert.equal(true, validationModule.validateEmail('analefinir@gmail.com'));
        });

        it('-Should get true, when pass as arguments: \'ana99@gmail.com\'', function () {
            assert.equal(true, validationModule.validateEmail('ana99@gmail.com'));
        });

        it('-Should get true, when pass as arguments: \'ana_@gmail.com\'', function () {
            assert.equal(true, validationModule.validateEmail('ana_@gmail.com'));
        });
    });

    describe('Testing function validationNumber', function () {
        it('-Should get false, when pass as arguments:\'222d\'', function () {
            assert.equal(false, validationModule.validateNumber('222d'));
        });
        it('-Should get false, when pass as arguments:\'22,3\'', function () {
            assert.equal(false, validationModule.validateNumber('22,3'));
        });

        it('-Should get false, when pass as arguments:\'x222\'', function () {
            assert.equal(false, validationModule.validateNumber('x222'));
        });

        it('-Should get false, when pass as arguments:\'22s3\'', function () {
            assert.equal(false, validationModule.validateNumber('22s3'));
        });

        it('-Should get true, when pass as arguments:\'222\'', function () {
            assert.equal(true, validationModule.validateNumber('222'));
        });

        it('-Should get true, when pass as arguments:\'22.3\'', function () {
            assert.equal(true, validationModule.validateNumber('22.3'));
        });
    });

    describe('Testing function validationIntegerNumber', function () {
        it('-Should get false, when pass as arguments:\'2dd\'', function () {
        ...
        it('-Should get true, when pass as arguments:\'0\'', function () {
            assert.equal(true, validationModule.validateIntegerNumber('0'));
        });
    });

    describe('Testing function validationFloatNumber', function () {
        it('-Should get false, when pass as arguments:\'222\'', function () {
        ...
        it('-Should get false, when pass as arguments:\'22s2.3\'', function () {
            assert.equal(false, validationModule.validateFloatNumber('22s3.3'));
        });

        it('-Should get false, when pass as arguments:\'s222\'', function () {
        ...
        it('-Should get true, when pass as arguments:\'0.3\'', function () {
            assert.equal(true, validationModule.validateFloatNumber('0.3'));
        });
    });

    describe('Testing function validationAlphanumericLowercase', function () {
        it('-Should get false, when pass as arguments:\'Ana\'', function () {
            assert.equal(false, validationModule.validateAlphanumericLowercase('Ana'));
        });

        it('-Should get false, when pass as arguments:\'FRANI\'', function () {
            assert.equal(false, validationModule.validateAlphanumericLowercase('FRANI'));
        });

        it('-Should get false, when pass as arguments:\'FRA_0\'', function () {
        ...
        it('-Should get false, when pass as arguments:\' \'', function () {
            assert.equal(false, validationModule.validateAlphanumericLowercase(' '));
        });

        it('-Should get false, when pass as arguments:\'ana_89\'', function () {
            assert.equal(false, validationModule.validateAlphanumericLowercase('ana_89'));
        });

        it('-Should get false, when pass as arguments:\' ana89\'', function () {
        ...
        it('-Should get true, when pass as arguments:\'ana\'', function () {
            assert.equal(true, validationModule.validateAlphanumericLowercase('ana'));
        });

        it('-Should get true, when pass as arguments:\'ana89\'', function () {
            assert.equal(true, validationModule.validateAlphanumericLowercase('ana89'));
        });

        it('-Should get true, when pass as arguments:\'ana 89\'', function () {
            assert.equal(true, validationModule.validateAlphanumericLowercase('ana 89'));
        });
    });

    describe('Testing function validationAlphanumeric', function () {
        it('-Should get true, when pass as arguments:\'ana\'', function () {
            assert.equal(false, validationModule.validateAlphanumeric('FRA.NI'));
        });

        it('-Should get false, when pass as arguments:\'FRA_?\'', function () {
        ...
        it('-Should get true, when pass as arguments:\'ana_89\'', function () {
            assert.equal(true, validationModule.validateAlphanumeric('ana_89'));
        });
    });

    describe('Testing function validationPrice', function () {
        it('-Should get false, when pass as arguments:\'222d\'', function () {
